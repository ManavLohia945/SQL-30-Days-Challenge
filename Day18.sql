...
--Question: Which metro city had the highest number of restaurant orders in September 2021?
...
WHERE city IN ('Delhi', 'Mumbai', 'Bangalore', 'Hyderabad') AND EXTRACT(MONTH FROM order_date) = '09'
GROUP BY 1
ORDER BY 2 DESC;
