...
--Write an SQL query to find the average order amount for male and female customers separately return the results with 2 DECIMAL.


SELECT c.gender, ROUND(AVG(o.total_amount),2)
...
SELECT TO_CHAR(order_date, 'MM'),SUM(quantity*price_per_unit) 
FROM SALES
